...
public class SettingsController : MonoBehaviour
{
    ...
    public void SetResolution(int resolutionNum)
    {
        switch (resolutionNum)
        {
            ...
            case 1: Screen.SetResolution(3440, 1440, Screen.fullScreen); break;
            case 2: Screen.SetResolution(2560, 1440, Screen.fullScreen); break;
            case 3: Screen.SetResolution(2560, 1080, Screen.fullScreen); break;
            case 4: Screen.SetResolution(1920, 1080, Screen.fullScreen); break;
            case 5: Screen.SetResolution(1280, 720, Screen.fullScreen); break;
        }
    }
    ...
    public void Add10PointsSG()
    {
        ShootingGalleryStoreManager.AddPoints(10);
    }
}
